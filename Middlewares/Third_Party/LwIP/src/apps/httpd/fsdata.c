...
#else
static const unsigned char data__index_html[] ="/index.html\0\
<!DOCTYPE html>\r\n\
<html>\r\n\
<body>\r\n\
\r\n\
<div id=\"mydemo\">\r\n\
<h1> AJAX test tables</h1>\r\n\
\r\n\
<table>\r\n\
  <tr>\r\n\
    <th>name</th>\r\n\
  ...
  <tr>\r\n\
    <td>Vtip(V):</td>\r\n\
    <td><input type=\"number\" id=\"vtip\" step=\"any\" value=\"-0.0\" min=\"-30000.0\" max=\"0.0\"></td>\r\n\
    <td><input type=\"button\" value=\"set\" name=\"vtip\" onclick=\"demand(this)\"></td>\r\n\
    <td><input type=\"button\" value=\"read\" name=\"vtip\" onclick=\"demand(this)\"></td>\r\n\
  </tr>\r\n\
  <tr>\r\n\
    <td>Itip(uA):</td>\r\n\
    <td><input type=\"number\" id=\"itip\" step=\"any\" value=\"0.0\" min=\"0.0\" max=\"500.0\"></td>\r\n\
    <td></td>\r\n\
    <td><input type=\"button\" value=\"read\" name=\"itip\" onclick=\"demand(this)\"></td>\r\n\
  </tr>\r\n\
  	<td>Debug:</td>\r\n\
	<td><select id = \"debug\">\r\n\
        ...
        <option value = \"3:debug\">3:debug</option>\r\n\
	</select></td>\r\n\
    <td><input type=\"button\" value=\"set\" name=\"debug\" onclick=\"demand(this)\"></td>\r\n\
	<td><input type=\"button\" value=\"read\" name=\"debug\" onclick=\"demand(this)\"></td>\r\n\
  </tr>\r\n\
</table>\r\n\
\r\n\
\r\n\
...
\r\n\
<script>\r\n\
function demand(button) {\r\n\
	var id = button.name\r\n\
	message = \"get?\"+id+\"=\";\r\n\
	if(button.value==\"set\")\r\n\
	{	\r\n\
		message = message+document.getElementById(id).value;\r\n\
	}\r\n\
	document.getElementById(\"hint\").innerHTML = \"Tx:\"+message    \r\n\
	...
	{\r\n\
		...
		for(k of arr)\r\n\
		{\r\n\
			if(-1==k.search(\"=\")){continue;}\r\n\
			a = k.split(\"=\");\r\n\
			if(a[1].length)\r\n\
			{\r\n\
				document.getElementById(a[0]).value = parseFloat(a[1]);\r\n\
			}\r\n\
		}\r\n\
...
static const unsigned char data__cgi_get[] = "/get\0vtip=-100.1&itip=20.8\r\n";
static const unsigned char data__cgi_post[] = "/post\0cgi_post\r\n";
...
const struct fsdata_file file__cgi_get[] = { {
file__index_html,
data__cgi_get,
data__cgi_get + 5,
sizeof(data__cgi_get) - 5,
1,
}};

const struct fsdata_file file__cgi_post[] = { {
file__cgi_get,
data__cgi_post,
data__cgi_post + 6,
sizeof(data__cgi_post) - 6,
1,
}};


#define FS_ROOT file__cgi_get
